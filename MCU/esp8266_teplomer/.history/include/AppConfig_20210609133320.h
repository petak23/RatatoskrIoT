...
// ================================= ID a verze aplikace
   ...
   */
  #define APP_VERSION_ID "PV_DHT22_01" 
...
// ================================= konfiguracni portal
  ...
  #define CONFIG_AP_PASSWORD "KodesZone1"
...
// ================================= obecna konfigurace
   ...
   */
  #define RA_CONFIG_PASSPHRASE "VelmiPracneHeslo672" 
...
//#include "./lib/wifiman/WiFiManager.h"
